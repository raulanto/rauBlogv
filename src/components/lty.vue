...
<template>
    ...
    <main class="pt-28 pb-28 lg:pt-28 lg:pb-24 bg-white dark:bg-gray-900 antialiased">
                ...
                <header class="mb-4 lg:mb-6 not-format">
                    <address class="flex items-center mb-6 not-italic">
                        <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                            ...
                            <div>
                                <a href="#" rel="author" class="text-xl font-bold text-gray-900 dark:text-white">RauAnto</a>
